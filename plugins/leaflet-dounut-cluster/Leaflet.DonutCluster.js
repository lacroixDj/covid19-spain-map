        ...
        for (i = 0; i < data.length; i++) {
            ...
            (function (d, c, perc) {
                ...
                arc.addEventListener('mouseenter', function (e) {
                    ...
                    t.saved = {
                        val: d.value,
                        legend: '<span style="border: 1px solid ' + c + '; background-color:rgba(255, 255, 255, 0) ;border-left-width:15px; padding:1px;">' + (d.title || d.name) + ':&nbsp;' + ((1*perc).toFixed(2)) + '%</span>'
                    }
    ...
    function createDonut(points, opt, cfgFn) {
        ...
        for (var i = 0; i < count; i++) {
            ...
            if (!sumField){
                ...
                blocks[s] += points[i].options[sumField];
            } 
        ...
        var realSize= Math.round(Math.sqrt(totalSum));
